...
You can then execute your native executable with: `./target/lambda-example-1.0.0-SNAPSHOT-runner`
...
- Amazon Alexa ([guide](https://quarkus.io/guides/amazon-lambda)): Write Amazon Alexa Skills with AWS Lambda or HTTPS endpoints
...
- AWS Lambda Gateway REST API ([guide](https://quarkus.io/guides/amazon-lambda-http)): Build parent to bring in required dependencies
